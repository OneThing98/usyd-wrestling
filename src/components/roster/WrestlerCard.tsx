  ...
  return (
    <div className="group border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden bg-white dark:bg-dark">
      ...
      <div className="p-4">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">{wrestler.year}</p>
        <p className="text-sm text-gray-500 dark:text-gray-500 mt-0.5">
          {wrestler.hometown}
        </p>
        {wrestler.highSchool && (
          <p className="text-xs text-gray-400 mt-0.5">{wrestler.highSchool}</p>
        )}

        {wrestler.socialLinks && (
          <div className="flex items-center gap-3 mt-3">
            {wrestler.socialLinks.twitter && (
              <a
                href={wrestler.socialLinks.twitter}
                target="_blank"
            ...
            {wrestler.socialLinks.instagram && (
              <a
                href={wrestler.socialLinks.instagram}
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-primary transition-colors"
            ...
            {wrestler.socialLinks.nilProfile && (
              <a
                href={wrestler.socialLinks.nilProfile}
                target="_blank"
                rel="noopener noreferrer"
                className="text-xs text-secondary hover:text-secondary/80 font-display uppercase tracking-wider transition-colors"
              >
                NIL
              </a>
            )}
